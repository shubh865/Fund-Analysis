...
const SOURCE_URL = 'https://www.sbimf.com/portfolios';
...
console.log(`Provisionally mapped ${mapped} SBI Growth plans to monthly disclosure portfolios by scheme family.`);
